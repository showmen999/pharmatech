...
<head>
  ...
  <link href="../asset/dashboard/demo/material-dashboard.css" rel="stylesheet" />
    ...
    -->
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="<?php echo base_url()?>appoint-table">
              <i class="material-icons">Appoint</i>
              <p>Appointment</p>
            </a>
          </li>
          <li class="nav-item ">
            <a class="nav-link" href="<?php echo base_url()?>medicine-table">
              <i class="material-icons">Purchase</i>
              <p>Puchase Medicine</p>
            </a>
          </li>
          <li class="nav-item ">
            <a class="nav-link" href="<?php echo base_url()?>contact-manage">
              <i class="material-icons">Contact</i>
              <p>Manage Contact</p>
            </a>
          </li>
          <li class="nav-item ">
            <a class="nav-link" href="<?php echo base_url()?>add-medcine">
              <i class="material-icons">Medicine</i>
              <p>Add Medicine</p>
            </a>
          </li>
          <li class="nav-item ">
            <a class="nav-link" href="<?php echo base_url()?>manage-medcine">
              <i class="material-icons">Medicine</i>
              <p>Manage Medicine</p>
            </a>
          </li>
...
<div class="container ml-5">
        ...
        <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
        	<div class="panel panel-default">
        		<div class="panel-heading">
			    		<h3 class="panel-title">Edit Medicine <small></small></h3>
			 			</div>
			 			<div class="panel-body">


			    		<form action ="<?php echo base_url()?>edit-medicine-by-id" method="post">
			    			<?php foreach($all_medicine_by_id as $medi_row){?>
			    				<div class="col-xs-6 col-sm-6 col-md-12">
			    					<div class="form-group">
                                    <input type="hidden" value="<?php echo $medi_row->medicine_id; ?>" name="medicine_id">
			                            <input type="text" value="<?php echo $medi_row->medicine_name?>"  name="medicine_name" id="first_name" class="form-control " placeholder="Medicine Name">
			    					</div>
			    				</div>
			    				<div class="col-xs-6 col-sm-6 col-md-12">
			    					<div class="form-group">
			                            <input type="text" value="<?php echo $medi_row->medicine_generic_name?>"  name="medicine_generic_name" id="first_name" class="form-control " placeholder="Medicine Generic Name">
			    					</div>
			    				</div>
			    				<div class="col-xs-6 col-sm-6 col-md-12">
			    					<div class="form-group">
			                            <input type="text" value="<?php echo $medi_row->medicine_strength?>"  name="medicine_strength" id="first_name" class="form-control " placeholder="Medicine Strength">
			    					</div>
			    				</div>
			    				<div class="col-xs-6 col-sm-6 col-md-12">
			    					<div class="form-group">
			                            <input type="number" min='1' value="<?php echo $medi_row->price?>"  name="price" id="first_name" class="form-control " placeholder="Per Packet">
			    					</div>
								</div>
  ...
  <script src="asset/dashboard/js/material-dashboard.js?v=2.1.2" type="text/javascript"></script>
  <!-- Material Dashboard DEMO methods, don't include it in your project! -->
  <script src="asset/dashboard/demo/demo.js"></script>

  <script src="asset/dashboard/js/sweetalert2@10.js"></script>
    ...
    if(isset($msg)){ ?>
        <script>
            Swal.fire(
                ...
                'We will call you for an appointment time',
                'success'
            )
        </script>
    <?php 
...
?>
  ...
  <?php
		...
		if(isset($msg)){ ?>
            ...
            position: 'top-end',
            icon: 'success',
            title: 'Medicine Inserted Successfully! ',
