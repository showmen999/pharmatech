    ...
    -->
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="<?php echo base_url()?>manage-medicine">
              <i class="material-icons">Medicine</i>
              <p>Manage Medicine</p>
            </a>
          </li>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Dashboard | <?php echo $this->session->userdata('admin_name');?></a>
          ...
          <a href="<?php echo base_url();?>logout" class="btn btn-dark btn-sm">Logout</a>
        </div>
      </nav>
